...
Lena Hartmann must recommend a focused intervention program at the next executive meeting. She does not have the budget to redesign all store processes at once. She needs to know which assortment, store cluster, process step, or data-quality issue should be addressed first.
